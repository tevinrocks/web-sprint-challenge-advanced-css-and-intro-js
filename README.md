...
Making your website user friendly. Easy to navigate and works on different devices.
2. Talk about 3 different things you can do to ensure your website is accessible. 
Making sure it works on any device, easy to find what you are looking for, the zoom in/out functions work accordingly, links work upon click.
3. How would you explain the concept of a variable to someone new to programming?
Used to store data into. The variable is the name of the storage container.
4. What is the purpose of using functions in code?
Keeps the code 'DRY'. You can recall a function if you need to reuse it later in the code.
